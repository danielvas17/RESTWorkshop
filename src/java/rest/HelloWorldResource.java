 ...
 * @author santi
 */
public class HelloWorldResource extends DefaultResouce {
     ...
     */
    private HelloWorldResource(String name) {
        this.name = name;
    }
     ...
     */
    public static HelloWorldResource getInstance(String name) {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of HelloWorldResource class.
        return new HelloWorldResource(name);
    }
